 ...
 */
public class QuestionAdapter extends ArrayAdapter<Topic> {


    public QuestionAdapter(Context context, List<Topic> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView tvName = (TextView) convertView.findViewById(R.id.questionname);
